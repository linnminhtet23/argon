...
const ROLECODE_REGEX_ERROR = 'Please select a valid user role';
const CONFIRM_PASSWORD_ALLOWONLY_ERROR = 'Password and Confirm password fields must match';
...
module.exports = {
  ...
  ROLECODE_REGEX_ERROR,
  CONFIRM_PASSWORD_ALLOWONLY_ERROR,
};
