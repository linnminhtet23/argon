...
import 'package:now_ui_pro_flutter/constants/Images.dart';

import 'package:now_ui_pro_flutter/screens/category.dart';

//widgets
import 'package:now_ui_pro_flutter/widgets/navbar.dart';
import 'package:now_ui_pro_flutter/widgets/card-category.dart';
...
final Map<String, List<Map>> beautyCards = {
  "Music": [
    ...
    },
    {
      "id": "concerts",
      "title": "Concerts",
      "image": images["trending"]["Concerts"],
      "products": [
        {
          "img":
  ...
  "Fashion": [
    ...
    },
    {
      "id": "accessory",
      "title": "Accessory",
      "image": images["trending"]["Accessory"],
      "products": [
        {
          "img":
  ...
  "Clothes": [
    ...
    },
    {
      "id": "garagesale",
      "title": "Garage Sale",
      "image": images["trending"]["Garage Sale"],
      "products": [
        {
          "img":
    ...
    },
    {
      "id": "weddingdress",
      "title": "Wedding Dress",
      "image": images["trending"]["Wedding Dress"],
      "products": [
        {
          "img":
